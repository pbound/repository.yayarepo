...
def add_item( action="" , title="" , plot="" , url="" ,thumbnail="" , extra="",mmsId="",page="",token="", isPlayable = False, folder=True ):
    ...
    #     sys.argv[0], action, urllib.quote_plus(title.encode('utf-8')), urllib.quote_plus(url.encode('utf-8')),
    #     urllib.quote_plus(thumbnail.encode('utf-8')), urllib.quote_plus(plot), urllib.quote_plus(extra),
